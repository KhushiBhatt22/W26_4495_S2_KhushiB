...
const ProfilePage = () => {
  ...
  const handleLike = async (bookId, isLiked) => {
    ...
    try {
      ...
      // Revert
      setBooks((prev) => prev.map((b) => b._id === bookId ? { ...b, isLiked: isLiked, likesCount: isLiked ? b.likesCount + 1 : b.likesCount - 1 } : b));
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto px-6 py-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                  ...
                  {!isOwnProfile && (
                    <button
                      ...
                      className={`flex items-center gap-2 px-6 py-2 rounded-lg font-semibold text-sm transition-all disabled:opacity-60 ${
                        isFollowing
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex justify-center sm:justify-start gap-8 mt-4">
                ...
                <p className="text-gray-400 text-sm mb-5">{profile?.email}</p>
      ...
      <CreateBookModal
        ...
        onBookCreated={(bookId) => { setIsCreateModalOpen(false); navigate(`/editor/${bookId}`); }}
      />
    </NewDashboardLayout>
  );
};
